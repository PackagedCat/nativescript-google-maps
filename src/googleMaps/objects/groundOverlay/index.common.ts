...
import { Coordinate, CoordinateBounds, coordinatePropertyValueConverter } from "../../models";

/**
 * Represents a class of ground overlay is an image that is fixed to a map
 */
export abstract class GroundOverlayBase extends MapObjectBase {
    /**
     ...
     */
    public bounds: CoordinateBounds;
...
export const boundsProperty = new Property<GroundOverlayBase, CoordinateBounds>({
    name: "bounds"
});
...
export const positionProperty = new Property<GroundOverlayBase, Coordinate>({
    name: "position",
