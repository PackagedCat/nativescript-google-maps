...
/**
 * Represents base class for the maps object
 */
export abstract class MapObject extends ViewBase {
	public parent: any;
    ...
    public createNativeView() {
        if (!(this.parent instanceof GoogleMap)) {
            throw new Error("Google map objects must be placed in the GoogleMap view");
		}
